...
local HealBot_Debuff_Spells = {
  -- CoA DEBUFF/CLEANSE --
  ["SUNCLERIC"] = {
    HEALBOT_BLIGHTBREAKER,
    HEALBOT_SHATTER_CURSE,
  },
  ["WITCHDOCTOR"] = {
...
local HealBot_Options_Class_HoTctlName_List = {
    ...
    -- CoA (HOTS POR CLASE) --
    [HEALBOT_SUNSHINE]=HEALBOT_SUNCLERIC,
    [HEALBOT_HOPE]=HEALBOT_SUNCLERIC,
    [HEALBOT_SHINE]=HEALBOT_SUNCLERIC,

    [HEALBOT_FROG_VENOM]=HEALBOT_WITCHDOCTOR,
    [HEALBOT_VOODOO_SERPENT_BEAM]=HEALBOT_WITCHDOCTOR,
    [HEALBOT_VOODOO_PUDDLE]=HEALBOT_WITCHDOCTOR,

    [HEALBOT_ACCELERATED_RECOVERY]=HEALBOT_CHRONOMANCER
    -- End CoA --
...
function HealBot_Options_update_cpSkin()
    -- table.foreach(HealBot_Options_CurCPSkins, print);
    print('CP_SKINS',HealBot_Options_CurCPSkins);
...
function HealBot_Options_GetDebuffSpells_List(class)
    for x,y in pairs(HealBot_Debuff_Spells[class]) do
        print(x,y);
    end
