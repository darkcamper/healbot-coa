...
for cName,cInfo in pairs(HEALBOT_CLASS_INFO) do
    local buffs = {};
    for bName,_ in pairs(cInfo.Buffs) do
        table.insert(buffs, bName);
    end

    HealBot_Buff_Spells_Total_List[cInfo.InvariantName] = buffs;
end
...
for cName,cInfo in pairs(HEALBOT_CLASS_INFO) do
    local debuffs = {};
    for deb,_ in pairs(cInfo.Debuffs) do
        table.insert(debuffs, deb);
    end

    HealBot_Debuff_Spells[cInfo.InvariantName] = debuffs;
end
...
for cName,cInfo in pairs(HEALBOT_CLASS_INFO) do
    for deb, debTypes in pairs(cInfo.Debuffs) do
        HealBot_Debuff_Types[deb]=debTypes;
    end
end
...
for cName,cInfo in pairs(HEALBOT_CLASS_INFO) do
    for healSpell,_ in pairs(cInfo.HealingSpells) do
        table.insert(HealBot_Options_SelectHealSpellsCombo_List, healSpell);
    end
end
...
for cName,cInfo in pairs(HEALBOT_CLASS_INFO) do
    for otherSpell,_ in pairs(cInfo.OtherSpells) do
        table.insert(HealBot_Options_SelectOtherSpellsCombo_List, otherSpell);
    end
end
...
for cName, cInfo in pairs(HEALBOT_CLASS_INFO) do 
    for hName,_ in pairs(cInfo.Hots) do
        HealBot_Options_Class_HoTctlName_List[hName]=cName;
    end
end
...
function HealBot_Options_Class_HoTctlAction_Refresh(onselect)
    ...
    local hbClass=HealBot_PlayerClassEN
...
for cName, cInfo in pairs(HEALBOT_CLASS_INFO) do
    if HEALBOT_UTILS.TableAny(cInfo.Hots) then
        table.insert(HealBot_Options_FilterHoTctl_List,cName);
    end
end
