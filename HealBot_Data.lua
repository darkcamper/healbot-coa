...
HealBot_Class_En = { 
                ...
                [HEALBOT_DEATHKNIGHT]="DEATHKNIGHT",
...
HealBot_GlobalsDefaults = {
    ...
    Custom_Debuff_Categories = {
        ...
        -- CoA Custom debuff categories ---

        [HEALBOT_DEBUFF_CURED] = 14,
        [HEALBOT_DEBUFF_SLIGHTLY_DIZZY] = 14,
    },
    HoTReserve = {
    },
    WatchHoT = {
...
for cName, cInfo in pairs(HEALBOT_CLASS_INFO) do
    if not HealBot_GlobalsDefaults.HoTReserve[cInfo.InvariantName] then
        HealBot_GlobalsDefaults.HoTReserve[cInfo.InvariantName] = {[1] = 1, [2] = 1, [3] = 1, [4] = 1};
    end
    if not HealBot_GlobalsDefaults.WatchHoT[cInfo.InvariantName] then
        local hots = {};
        for hName,_ in pairs(cInfo.Hots) do
            hots[hName] = 2;
        end

        HealBot_GlobalsDefaults.WatchHoT[cInfo.InvariantName] = hots;
    end
end
